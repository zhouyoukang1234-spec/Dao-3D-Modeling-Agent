"""End-to-end closure demo: one live FreeCAD kernel, four physics failure modes,
each validated against its closed form, plus a rendered stress contour.

Run:  python examples/demo_closure.py
(spawns freecadcmd via FREECADCMD / standard install paths)
"""
import math
import os
import sys
